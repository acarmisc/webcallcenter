...
class Home extends CI_Controller{
	...
	public function index(){
		...
		if(Sicurezza::verificaUtente(false)){
				/*$data['mostra_form_login']=false;
				$data['info_utente']=Utente_Corrente::informazioni();
				$data['nome_completo']=$data['info_utente']['nome_completo'];
				$data['data_toolbar']['voci_toolbar']=Sicurezza::vociToolbar();*/
