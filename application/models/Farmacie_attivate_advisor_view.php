<?php
Doctrine_Manager::getInstance()->bindComponent('Farmacie_attivate_advisor_view', 'default');

class Farmacie_attivate_advisor_view extends Doctrine_Record{
	public function setTableDefinition(){
		$this->setTableName('farmacie_attivate_advisor_view');
