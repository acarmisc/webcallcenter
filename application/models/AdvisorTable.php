 ...
 */
class AdvisorTable extends Doctrine_Table
{
    /**
     * Returns an instance of this class.
     *
     * @return object AdvisorTable
     */
    public static function getInstance()
    {
        return Doctrine_Core::getTable('Advisor');
    }
    
//Restituisce un array di array (id,nome) con id codice dell'Advisor e nome il suo nome completo
    public function elencoNomi(){
    	$q=$this->createQuery()->
    		select('a.id, u.nome_completo')->
    		from('Advisor a')->
    		leftjoin('a.Utente u')->
    ...
    public function statistiche(){
    	...
    	$r=$q->execute(array(),Doctrine_Core::HYDRATE_ARRAY);
    		...
    		$p=Doctrine_Query::create()->
    			...
    			groupBy('nome')->
    			orderBy('nome');
    		$q=$p->execute(array(),Doctrine_Core::HYDRATE_ARRAY);
    		$p=Doctrine_Query::create()->
			...
			foreach($tipi as $tipo){
	    		$s=Doctrine_Query::create()->
	    			...
	    			groupBy('nome')->
	    			orderBy('nome');
	    		$t=$s->execute(array(),Doctrine_Core::HYDRATE_ARRAY);
			}	
		//return $q->toArray();
		return $q;
    }*/
